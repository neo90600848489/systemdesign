== and equals() -> for primitive check value , equals check content , for string x="hello", string y="hello" x==y -> true
...
fail-fast vs fail safe iterator , copyonarrayList() make it failsafe iterator 
